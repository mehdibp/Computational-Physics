/*******************************************************************************************************/
/***                                                                                                 ***/
/***  Template code for a projectile motion - part B                                                 ***/
/***                                                                                                 ***/
/***  Projectile motion - part B, v1.0; Date: 1400/03/07                                             ***/
 ...
 * and R() and Openfile() and  run() functions.
 */
...
void run() {
    ...
    for (float theta0 = 0; theta0 < 0.51*M_PI; theta0 += 0.01) {
        ...
        res << theta0 * 180 / M_PI << "\t\t" << R_drag(theta0) 
                                   << "\t\t" << R_dragless(theta0) 
                                   << "\t\t" << R_exact(theta0) << endl;		// copy in file
    }
