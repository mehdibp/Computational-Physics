...
/***                                                                                                 ***/
/***  Molecular dynamics - part 1, v1.0; Date: 1399/03/20                                            ***/
...
void init() {
    iseed = -10;                // That initiates the seed of the random number generator. Add the comment 
...
void done() { path.close();  res.close(); }
